namespace :db do
  ...
  namespace :populate do
    ...
    def generate_user
      User.destroy_all
      User.create!(email: "tnbredillet@gmail.com", password: "wer0ckadm1n!", password_confirmation: "wer0ckadm1n!", firstname: "Thomas", lastname: "Bredillet")
      User.create!(email: "antoinedematteo@gmail.com", password: "wer0ckadm1n!", password_confirmation: "wer0ckadm1n!", firstname: "Antoine", lastname: "Dematteo")
      User.create!(email: "alexandre.bessis@gmail.com", password: "wer0ckadm1n!", password_confirmation: "wer0ckadm1n!", firstname: "Alexandre", lastname: "Bessis")
